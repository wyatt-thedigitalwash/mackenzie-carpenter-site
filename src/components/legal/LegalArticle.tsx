    ...
    case "h2":
      return (
        <h2
          ...
          style={{ color: "var(--text-accent)", scrollMarginTop: "11rem" }}
        >
          {block.text}
        </h2>
      );
    ...
    case "p":
      return (
        <p
          ...
          style={block.id ? { scrollMarginTop: "11rem" } : undefined}
        >
...
export default function LegalArticle({
  ...
  return (
    <>
      <section data-bg="primary" className="bg-background-primary px-5 pt-40 md:pt-48 pb-4 lg:px-12">
