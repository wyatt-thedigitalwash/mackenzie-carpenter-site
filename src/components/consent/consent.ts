...
export const CATEGORY_META: { key: Category; label: string; locked?: boolean; description: string }[] = [
  ...
  },
  {
    key: "social",
    label: "Social media",
    description: "Enable sharing and content from social media platforms such as Instagram, Facebook, TikTok, X and YouTube.",
  },
];

export const STORAGE_KEY = "mc-cookie-consent";
