...
export const metadata: Metadata = {
  ...
  description:
    "Terms and policies for the Mackenzie Carpenter official website, operated by Borchetta Entertainment Group, LLC and its affiliates.",
  alternates: { canonical: "https://mackenziecarpentermusic.com/legal" },
...
export default function LegalHubPage() {
  return (
    <section data-bg="primary" className="bg-background-primary px-5 pt-40 md:pt-48 pb-20 md:pb-28 lg:px-12">
